...
// Extract info from data-* attributes
  ...
  var modal = $(this)
  modal.find('.modal-title').text('OPEN IN MOBILE ')
  modal.find('.modal-body input').val()
})
$('#Spounser').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the modal
// Extract info from data-* attributes
  // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
...
$('#enterprice').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the modal
// Extract info from data-* attributes
  // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
 ...
 $(document).ready(function(){
    $(".appfeaturesfirst").hover(function(){
        $("#mobilescreen").css("background-image", "url('/images/Run cause feed.png')");
        }, function(){
        $("#mobilescreen").css("background-image", "url('/images/Run cause feed.png')");
    });
});
 ...
 $(document).ready(function(){
    $(".appfeaturesecond").hover(function(){
        $("#mobilescreen").css("background-image", "url('/images/Thank you run.png')");
        }, function(){
        $("#mobilescreen").css("background-image", "url('/images/Thank you run.png')");
    });
});
  ...
  $(document).ready(function(){
    $(".appfeaturesthird").hover(function(){
        $("#mobilescreen").css("background-image", "url('/images/Begin run.png')");
        }, function(){
        $("#mobilescreen").css("background-image", "url('/images/Begin run.png')");
    });
});
   ...
   $(document).ready(function(){
    $(".appfeatureforth").hover(function(){
        $("#mobilescreen").css("background-image", "url('/images/Run going on.png')");
        }, function(){
        $("#mobilescreen").css("background-image", "url('/images/Run going on.png'");
    });
});
